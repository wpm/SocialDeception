...
| [0010](0010-a-handler-sets-its-own-deadline.md) | A handler sets its own deadline | Proposed |
| [0011](0011-werewolf-phases-are-timed-pointing-sessions.md) | Werewolf phases are timed pointing sessions | Proposed |
| [0012](0012-a-dead-player-stops.md) | A dead player stops | Proposed |
| [0013](0013-speech-typing-and-a-scheduler-for-when-to-speak.md) | Speech and typing are events, and a scheduler decides when to speak | Proposed |
