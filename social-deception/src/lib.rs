...
//! a player folds those events into, the [`Game`](werewolf::Game) whose
//! rules decide what is said to whom, and the
//! [`Moderator`](werewolf::Moderator) that runs it as an agent in the
//! roster.
